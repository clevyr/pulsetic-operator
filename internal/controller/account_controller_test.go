...
func CreateAccount(ctx context.Context) (*pulseticv1.Account, *corev1.Secret) {
...
func ReconcileAccount(ctx context.Context, account *pulseticv1.Account) {
...
func CleanupAccount(ctx context.Context, account *pulseticv1.Account, secret *corev1.Secret) {
	if account != nil {
